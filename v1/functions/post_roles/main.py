...
from methods.delete import delete  # noqa: E402
...
def handle(e, context):
    ...
    if e.get('httpMethod') == 'GET':
        body['data'], body['meta'], body['message'], status_code = get(e=e)  # noqa: E501
    if e.get('httpMethod') == 'POST':
        body['data'], body['meta'], body['message'], status_code = post(e=e, context=context)  # noqa: E501
    elif e.get('httpMethod') == 'DELETE':
        body['data'], body['meta'], body['message'], status_code = delete(e=e)
